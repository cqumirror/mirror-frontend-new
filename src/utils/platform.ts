...
// 平台检测、架构检测、平台图标与标签 —— GithubReleaseViewer 与 MirrorDetail 共用
...
export function detectPlatform(name: string): Platform {
  ...
  if (f.endsWith('.ttf') || f.endsWith('.otf') || f.endsWith('.woff') || f.endsWith('.woff2'))
    return 'font';
  if (
    f.endsWith('.zip') ||
    f.endsWith('.tar') ||
...
// macOS Apple logo (版权原因不能用 emoji，unicode 私有区在非 Apple 系统不渲染)
export const AppleIcon: React.FC<{ style?: React.CSSProperties }> = ({ style }) =>
...
// Windows logo
export const WindowsIcon: React.FC<{ style?: React.CSSProperties }> = ({ style }) =>
  React.createElement('svg', {
    viewBox: '0 0 24 24',
    width: '1em',
    height: '1em',
    ...
    'aria-hidden': 'true',
    children: React.createElement('path', {
      d: 'M3 12.5v-8l7-1v8.5H3zm8 0V3.2l10-1.5V12.5h-10zM3 13.5h7v8.5l-7-1v-7.5zm8 0h10v10.3l-10-1.5V13.5z',
    }),
  });

// Linux Tux
export const LinuxIcon: React.FC<{ style?: React.CSSProperties }> = ({ style }) =>
  React.createElement('svg', {
...
export const AndroidIcon: React.FC<{ style?: React.CSSProperties }> = ({ style }) =>
  React.createElement('svg', {
    ...
    'aria-hidden': 'true',
    children: [
      React.createElement('path', { d: 'M0 0h24v24H0z', fill: 'none', key: 'bg' }),
...
// 通用/跨平台包
export const PackageIcon: React.FC<{ style?: React.CSSProperties }> = ({ style }) =>
  React.createElement('svg', {
    xmlns: 'http://www.w3.org/2000/svg',
    width: '1em',
    height: '1em',
...
// 字体
export const FontFileIcon: React.FC<{ style?: React.CSSProperties }> = ({ style }) =>
  React.createElement('svg', {
    xmlns: 'http://www.w3.org/2000/svg',
    width: '1em',
    height: '1em',
    ...
    'aria-hidden': 'true',
    children: [
      React.createElement('path', { d: 'M0 0h12v12H0z', fill: 'none', key: 'bg' }),
      React.createElement('path', {
        fill: 'currentColor',
        d: 'M0 12h11V3h-1v1H8V2h1V1H0Zm1-1V2h6v3h3v6Zm4-2h1V6h1V5H4V4h1V3H2v1h1v3h1V6h1Zm2 1h1V9h1V8H8V7h1V6H7Zm2-7h1V2H9Zm0 0',
        key: 'body',
      }),
    ],
  });
...
// 压缩包
export const ArchiveFileIcon: React.FC<{ style?: React.CSSProperties }> = ({ style }) =>
  React.createElement('svg', {
    xmlns: 'http://www.w3.org/2000/svg',
    width: '1em',
    height: '1em',
    ...
    children: [
      ...
      React.createElement('path', {
        fill: 'currentColor',
        d: 'M12 17v-2h2v2zm2-4v-2h-2v2zm0-4V7h-2v2zm-4 2h2V9h-2zm0 4h2v-2h-2zM21 5v14c0 1.1-.9 2-2 2H5c-1.1 0-2-.9-2-2V5c0-1.1.9-2 2-2h14c1.1 0 2 .9 2 2m-2 0h-7v2h-2V5H5v14h14z',
        key: 'body',
      }),
    ],
  });
...
export const PLATFORM_ICON: Record<Platform, React.ReactNode> = {
  windows: React.createElement(WindowsIcon, { style: { fontSize: '1rem', width: '1rem', height: '1rem' } }),
  linux: React.createElement(LinuxIcon, { style: { fontSize: '1rem', width: '1rem', height: '1rem' } }),
  macos: React.createElement(AppleIcon, { style: { fontSize: '1rem', width: '1rem', height: '1rem' } }),
  android: React.createElement(AndroidIcon, { style: { fontSize: '1rem', width: '1rem', height: '1rem' } }),
  font: React.createElement(FontFileIcon, { style: { fontSize: '1rem', width: '1rem', height: '1rem' } }),
  archive: React.createElement(ArchiveFileIcon, { style: { fontSize: '1rem', width: '1rem', height: '1rem' } }),
  checksum: null, // 用 MUI VerifiedUser 图标，在渲染处单独处理
  other: React.createElement(PackageIcon, { style: { fontSize: '1rem', width: '1rem', height: '1rem' } }),
};
