export const meta = {
    ...
    date: "2019-09-04",
    author: "weearc",
    summary: "Multiple IPs permanently and temporarily banned due to abusive requests and web attacks.",
...
1. If you have any issues, please visit [feedback](https://github.com/cqumirror/feedback/issues/3)
2. GEOIP and other data sourced from: https://ipip.net
